...
# adam = Client.new("Adam")
# mindy = Trainer.new("Mindy")
# adam.assign_trainer(mindy)
# ebf_mid = Location.new("EBF - Midtown")
# box = mindy.train_client(adam, ebf_mid)

zuck = User.new("Zuckerberg")
winkl1 = User.new("Voss")
winkl2 = User.new("Vossier")
musk = User.new("Elon")
tesla = Project.new("Tesla", 200000)
fbook = Project.new("Facebook", 10)

winkl1.create_pledge(fbook, 30)
winkl1.create_pledge(fbook, 30)
winkl2.create_pledge(tesla, 300)
zuck.create_pledge(fbook,1)
zuck.create_project(fbook)
musk.create_project(tesla)
